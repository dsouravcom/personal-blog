        ...
        <div>
            ...
            <nav class="mt-6 px-3 space-y-1">
                ...
                <a href="{{ route('admin.subscribers.index') }}"
                   class="sidebar-link group flex items-center px-3 py-2 text-sm font-medium rounded-md text-gray-400 hover:text-white hover:bg-gray-800 transition-all {{ request()->routeIs('admin.subscribers.*') ? 'active' : '' }}">
                    <svg class="mr-3 h-5 w-5 opacity-70 group-hover:opacity-100" fill="none" viewBox="0 0 24 24" stroke="currentColor">
